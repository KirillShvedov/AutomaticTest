...
Сценарий: <описание сценария>
    ...
    И я проверяю значения документа    
        ...
        | МКД                                 | Номер       | Филиал                      | Вид благоустройства                                  |
        | 'Кемерово г, Ленина пр-кт, Дом 98А' | 00000000004 | Кемеровский городской округ | 'отопление, дома строительным объемом от 10000 м3 +' |
