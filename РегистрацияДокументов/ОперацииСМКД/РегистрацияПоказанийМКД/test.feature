...
Сценарий: <описание сценария>
    ...
    И я заполняю форму открывшегося документа  
        ...
        И в таблице "ШкалыПриборовУчетаЕстьШкалыНетТарифныхЗон" в поле 'Текущие показания' я ввожу текст '50,0000'
        ...
        |Шкала      |Ед. изм. |Предыдущие показания |Дата предыдущих показаний |Текущие показания |Состояние показаний |Переворот |Средний объем |Коэффициент ПУ |
        |'Основная' |'м3'     |''                   |''                        |'50,0000'         |'Приняты'           |'Нет'     |''            |'1,00000'      |
