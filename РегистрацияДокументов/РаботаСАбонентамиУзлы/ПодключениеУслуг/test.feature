    ...
    И я подготавливаю тестовые данные
        И я загружаю макет "РегистрацияДокументов\ОперацииСМКД\РаботаСАбонентамиУзлы\ПодключениеУслуг\ИсходныеДанные.mxl"
    ...
    И я заполняю форму открывшегося документа     
        ...
        И в таблице "ТочкиУчета" из выпадающего списка с именем "ТочкиУчетаЕстьШкалыЕстьТарифныеЗоныУслуга1" я выбираю точное значение 'Холодное водоснабжение (ХВС)'
        ...
        И в таблице "ТочкиУчета" из выпадающего списка с именем "ТочкиУчетаЕстьШкалыЕстьТарифныеЗоныРасположение1" я выбираю точное значение 'ТУ2'
        И в таблице "ТочкиУчета" я завершаю редактирование строки
    ...
    И я проверяю заполнение списка документов    
        ...
        | 'Астраханцев Вячеслав Владимирович' | Подключение услуги | 'Северск г, Матросова ул, Дом № 6б'   | Глазов  |