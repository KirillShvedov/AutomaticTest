...
Сценарий: <описание сценария>
    И я подготавливаю тестовые данные
        И я загружаю макет "РегистрацияДокументов\РаботаСМКДУзлы\ОткрытиеМКД\ИсходныеДанные.mxl"
    ...
    И я заполняю форму открывшегося документа     
        ...
        И из выпадающего списка "Улица" я выбираю по строке 'Кирова'
        И из выпадающего списка "Дом" я выбираю по строке '99А'
