    ...
    Сценарий: <ИзменениеКолваСобст>
    И я подготавливаю тестовые данные
        И я загружаю макет "ИзменениеКолваСобст.mxl"
    ...
    И я создаю документ "Изменение количество собственников"
        ...
        И в поле 'Количество собственников' я ввожу текст '5'
    И я провожу и записываю документ    
        И я нажимаю на кнопку 'Провести и закрыть'
        И я жду закрытия окна 'Установить количество собственников (создание) *' в течение 20 секунд
