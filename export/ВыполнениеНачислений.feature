...
Сценарий: Я запускаю выполнение начислений по организации "яОрганизация" и району "яРайон" и МКД "яМКД" и МКД '' с "ПериодНачало" "ГодНачало" по "ПериодОкончание"
    ...
    И Если "Не ПустаяСтрока(контекст.МКД)" Тогда
