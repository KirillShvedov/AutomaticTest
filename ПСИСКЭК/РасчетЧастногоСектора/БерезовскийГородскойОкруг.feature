    ...
    И я проверяю полученные результаты
        ...
        И я выбираю пункт контекстного меню с именем 'СписокКонтекстноеМенюНайти' на элементе формы с именем "Список"
        Тогда открылось окно 'Найти'
        И из выпадающего списка "&Что искать" я выбираю по строке 'Березовский городской округ'
        И я перехожу к следующему реквизиту
        И я нажимаю на кнопку '&Найти'
     И я проверяю начисления за июль   
        ...
        |'Трушков Анатолий Михайлович'       |'3,971167'   |'5 225,16'    |
        |'Пашкин Юрий Сергеевич'             |'6,477267'   |'9 559,86'    |
        |'Милешина Алена Валерьевна'         |'1,133517'   |'1 960,60'    |
        |'Амирян Нвард Эдиковна'             |'13,934060'   |'10 263,91‬'    |
        |'Маркидонов Александр Александрович'|'2,142690'   |'3 706,13'    |     
    И я проверяю начисления за август   
        ...
        И итог таблицы "Список" по полям "Абонент" стал равен шаблону:
        |Абонент                             |Объем услуги  |Сумма       |
        |'Трушков Анатолий Михайлович'       |'4,971167'    |'5 311,21'  |
        |'Пашкин Юрий Сергеевич'             |'6,477267'    |'9 559,86'  |
        |'Милешина Алена Валерьевна'         |'1,133517'    |'1 960,60'  |
        |'Амирян Нвард Эдиковна'             |'13,934060'   |'10 263,91‬' |
        |'Маркидонов Александр Александрович'|'2,142690'    |'3 706,13'  |
    ...
    И я проверяю начисления за октябрь
        ...
        |Абонент                             |Объем услуги  |Сумма       |
        |'Трушков Анатолий Михайлович'       |'4,971167'    |'5 311,21'  |
        |'Пашкин Юрий Сергеевич'             |'9,477267‬'    |'9 818,01'  |
        |'Милешина Алена Валерьевна'         |'1,133517'    |'1 960,60'  |
        |'Амирян Нвард Эдиковна'             |'10,934060'   |'10 694,16' |
        |'Маркидонов Александр Александрович'|'2,142690'    |'3 706,13'  |
    И я проверяю начисления за ноябрь
        ...
        |Абонент                             |Объем услуги  |Сумма       |
        |'Трушков Анатолий Михайлович'       |'4,971167'    |'5 311,21'  |
        |'Пашкин Юрий Сергеевич'             |'8,477267'    |'9 731,96'  |
        |'Милешина Алена Валерьевна'         |'1,133517'    |'1 960,60'  |
        |'Амирян Нвард Эдиковна'             |'13,100727'   |'10 880,60' |
        |'Маркидонов Александр Александрович'|'2,142690'    |'3 706,13'  |
    И я проверяю начисления за декабрь  
        ...
        |'Пашкин Юрий Сергеевич'             |'9,477267‬'    |'9 818,01'  |
        |'Милешина Алена Валерьевна'         |'1,133517'    |'1 960,60'  |
        |'Амирян Нвард Эдиковна'             |'10,767393'   |'10 679,82‬' |
        |'Маркидонов Александр Александрович'|'2,142690'    |'3 706,13'  |
