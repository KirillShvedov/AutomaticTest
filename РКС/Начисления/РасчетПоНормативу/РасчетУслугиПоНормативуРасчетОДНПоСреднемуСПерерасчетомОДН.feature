...
Сценарий: <РасчетПоНормативуСПерерасчетомОДН>
    ...
    И Я проверяю полученные результаты
        ...
        |Период                |Распределение |Абонент                   |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма по повышенному коэффициенту |
        |'25.06.2020 23:59:59' |'Нет'         |'Андреева Анна Сергеевна' |'Электроэнергия' |'ввод_Электроэнергия' |'Начисление'     |'По нормативу'           |'Без ПУ'      |'4,270'         |'26.05.2020'   |'26.06.2020'  |'538,02'                          |
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Распределение |Абонент                   |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма по повышенному коэффициенту |
        |'25.07.2020 23:59:59' |'Нет'         |'Андреева Анна Сергеевна' |'Электроэнергия' |'ввод_Электроэнергия' |'Начисление'     |'По нормативу'           |'Без ПУ'      |'4,270'         |'26.06.2020'   |'26.07.2020'  |'538,02'                          |
        И в таблице "Список" текущая строка равна:
        |Сумма         |Объем услуги |Объем потребленный |
        |'1614,06'     |'252,000000' |''                 |
        И в таблице "Список" я перехожу к строке:
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Распределение |Абонент                   |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма по повышенному коэффициенту |
        |'25.08.2020 23:59:59' |'Нет'         |'Андреева Анна Сергеевна' |'Электроэнергия' |'ввод_Электроэнергия' |'Начисление'     |'По нормативу'           |'Без ПУ'      |'4,270'         |'26.07.2020'   |'26.08.2020'  |'538,02'                          |
        И в таблице "Список" текущая строка равна:
        |Сумма         |Объем услуги |Объем потребленный |
        |'1614,06'     |'252,000000' |''                 |
        И в таблице "Список" я перехожу к строке:
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Распределение |Абонент                   |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма по повышенному коэффициенту |
        |'25.09.2020 23:59:59' |'Нет'         |'Андреева Анна Сергеевна' |'Электроэнергия' |'ввод_Электроэнергия' |'Начисление'     |'По нормативу'           |'Без ПУ'      |'4,270'         |'26.08.2020'   |'26.09.2020'  |'538,02'                          |
        И в таблице "Список" текущая строка равна:
        |Сумма         |Объем услуги |Объем потребленный |
        |'1614,06'     |'252,000000' |''                 |
        И в таблице "Список" я перехожу к строке:
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Распределение |Абонент                   |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма по повышенному коэффициенту |
        |'25.10.2020 23:59:59' |'Нет'         |'Андреева Анна Сергеевна' |'Электроэнергия' |'ввод_Электроэнергия' |'Начисление'     |'По нормативу'           |'Без ПУ'      |'4,270'         |'26.09.2020'   |'26.10.2020'  |'538,02'                          |
        И в таблице "Список" текущая строка равна:
        |Сумма         |Объем услуги |Объем потребленный |
        |'1614,06'     |'252,000000' |''                 |
        И в таблице "Список" я перехожу к строке:
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Распределение |Абонент                   |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма по повышенному коэффициенту |
        |'25.11.2020 23:59:59' |'Нет'         |'Андреева Анна Сергеевна' |'Электроэнергия' |'ввод_Электроэнергия' |'Начисление'     |'По нормативу'           |'Без ПУ'      |'4,270'         |'26.10.2020'   |'26.11.2020'  |'538,02'                          |
        И в таблице "Список" текущая строка равна:
        |Сумма         |Объем услуги |Объем потребленный |
        |'1614,06'     |'252,000000' |''                 |
        И в таблице "Список" я перехожу к строке:
