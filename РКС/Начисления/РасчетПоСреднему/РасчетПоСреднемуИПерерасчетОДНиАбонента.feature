...
Сценарий: <РасчетПоСреднему>
    ...
    И Я проверяю полученные результаты
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.09.2020 23:59:60' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |''                    |'Перерасчет'     |'По приборам'            |''            |'4,270'         |''             |''            |'-493,9'  |'-110'        |'-110,000000'      |
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.09.2020 23:59:61' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |''                    |'Перерасчет'     |'По приборам'            |''            |'4,270'         |''             |''            |'-295,45' |'-95'         |'-95,000000'       |
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.09.2020 23:59:62' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |'ввод_Электроэнергия' |'Перерасчет'     |'Среднее по нормативу'   |'Без ПУ'      |'4,270'         |''             |''            |'-72,59'  |'-17,000000'  |'-17,000000'       |
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.11.2020 23:59:59' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |''                    |'Перерасчет'     |'По приборам'            |''            |'4,270'         |''             |''            |'-493,90' |'-110,00'     |'-110'             |
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.11.2020 23:59:59' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |''                    |'Перерасчет'     |'По приборам'            |''            |'4,270'         |''             |''            |'-295,45' |'-95,00'      |'-95'              |
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.11.2020 23:59:59' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |''                    |'Перерасчет'     |'По приборам'            |''            |'4,270'         |''             |''            |''        |''            |''                 |
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.11.2020 23:59:59' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |''                    |'Перерасчет'     |'По приборам'            |''            |'4,270'         |''             |''            |''        |''            |''                 |
        И в таблице "Список" я перехожу к строке:
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.11.2020 23:59:59' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |''                    |'Перерасчет'     |'По приборам'            |''            |'4,270'         |''             |''            |'-180,11' |'-42,18'      |'-42,18'           |
        И в таблице "Список" я перехожу к строке:
        |Период                |Организация        |Абонент                           |Услуга           |Точка учета           |Вид начисления   |Способ начисления        |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма     |Объем услуги  |Объем потребленный |
        |'25.11.2020 23:59:59' |'ООО "РКС-энерго"' |'Калюжная Светлана Александровна' |'Электроэнергия' |''                    |'Перерасчет'     |'Начисление по среднему' |''            |'4,270'         |''             |''            |'58,86'   |'13,78'       |'13,78465116'      |