#language: ru
    ...
    И Я проверяю полученные результаты
        ...
        |'Аксёнов  Александр Павлович' |'26.08.2020'|'25.06.2020'    |'16'                             |'46'                          |'1'                     |'300'                 |'5'                     |'593,53'            |'1,58'     |'11.07.2020'                |
        ...
        И в таблице "ДанныеНачислений"я перехожу к строке:
        |Абонент                       |Период      |Дата начисления |Дней просрочки в текущем периоде |Количество дней задолженности |Коэффициент знаменатель |Коэффициент числитель |Ставка рефинансирования |Сумма задолженности |Сумма пени |Дата начала начисления пени |
        |'Аксёнов  Александр Павлович' |'26.09.2020'|'25.06.2020'    |'31'                             |'77'                          |'1'                     |'300'                 |'5'                     |'593,53'            |'3,07'     |'11.07.2020'                |
        И Я закрываю окно 'Начисление пени * от *'
        Тогда открылось окно 'Начисление пени'
        И в таблице "Список" я перехожу к строке:
		| Дата                |
        ...
        И в таблице "ДанныеНачислений"я перехожу к строке:
        |Абонент                       |Период      |Дата начисления |Дней просрочки в текущем периоде |Количество дней задолженности |Коэффициент знаменатель |Коэффициент числитель |Ставка рефинансирования |Сумма задолженности |Сумма пени |Дата начала начисления пени |
        |'Аксёнов  Александр Павлович' |'02.10.2020'|'25.06.2020'    |'6'                              |'83'                          |'1'                     |'300'                 |'5'                     |'593,53'            |'0,59'     |'11.07.2020'                |
        И в таблице "ДанныеНачислений" я перехожу к строке:
        |Абонент                       |Период      |Дата начисления |Дней просрочки в текущем периоде |Количество дней задолженности |Коэффициент знаменатель |Коэффициент числитель |Ставка рефинансирования |Сумма задолженности |Сумма пени |Дата начала начисления пени |
        |'Аксёнов  Александр Павлович' |'08.10.2020'|'25.06.2020'    |'7'                              |'90'                          |'1'                     |'300'                 |'6'                     |'593,53'            |'0,83'     |'11.07.2020'                |
        И в таблице "ДанныеНачислений" я перехожу к строке:
        |Абонент                       |Период      |Дата начисления |Дней просрочки в текущем периоде |Количество дней задолженности |Коэффициент знаменатель |Коэффициент числитель |Ставка рефинансирования |Сумма задолженности |Сумма пени |Дата начала начисления пени |
        |'Аксёнов  Александр Павлович' |'26.10.2020'|'25.06.2020'    |'17'                             |'107'                         |'1'                     |'130'                 |'6'                     |'593,53'            |'4,66'     |'11.07.2020'                |
        И Я закрываю окно 'Начисление пени * от *'
        Тогда открылось окно 'Начисление пени'
        И в таблице "Список" я перехожу к строке:
		| Дата                |
        ...
        И в таблице "ДанныеНачислений"я перехожу к строке:
        |Абонент                       |Период      |Дата начисления |Дней просрочки в текущем периоде |Количество дней задолженности |Коэффициент знаменатель |Коэффициент числитель |Ставка рефинансирования |Сумма задолженности |Сумма пени |Дата начала начисления пени |
        |'Аксёнов  Александр Павлович' |'15.11.2020'|'25.06.2020'    |'20'                             |'127'                         |'1'                     |'130'                 |'6'                     |'593,53'            |'5,48'     |'11.07.2020'                |
        И в таблице "ДанныеНачислений" я перехожу к строке:
        |Абонент                       |Период      |Дата начисления |Дней просрочки в текущем периоде |Количество дней задолженности |Коэффициент знаменатель |Коэффициент числитель |Ставка рефинансирования |Сумма задолженности |Сумма пени |Дата начала начисления пени |
        |'Аксёнов  Александр Павлович' |'25.11.2020'|'25.06.2020'    |'11'                             |'138'                         |'1'                     |'130'                 |'6'                     |'593,53'            |'1,99'     |'11.07.2020'                |