#language: ru
    ...
    И Я проверяю полученные результаты
        ...
        И из выпадающего списка "&Что искать" я выбираю по строке 'Давыдов Николай Степанович'
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Строение                             |Помещение               |Абонент                      |Услуга           |Точка учета           |Вид начисления   |Способ начисления |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма   |Объем услуги |Объем потребленный |
        |'25.06.2020 23:59:59' |'Волхов г, Маяковского ул, Дом № 11' |'Квартира 3, Комната 1' |'Давыдов Николай Степанович' |'Электроэнергия' |''                    |'Начисление ОДН' |'По нормативу'    |'Без ПУ'      |'3,110'         |''             |''            |'17,62' |'5,666667'   |''                 |
        И в таблице "Список" я перехожу к строке:
        |Период                |Строение                             |Помещение               |Абонент                      |Услуга           |Точка учета           |Вид начисления   |Способ начисления |Тарифная зона |Значение тарифа |Начало периода |Конец периода |Сумма   |Объем услуги |Объем потребленный |
        |'25.06.2020 23:59:59' |'Волхов г, Маяковского ул, Дом № 11' |'Квартира 3, Комната 1' |'Давыдов Николай Степанович' |'Электроэнергия' |''                    |'Начисление ОДН' |'По нормативу'    |'Без ПУ'      |'3,110'         |''             |''            |''      |''           |'5,666667'         |
