...
# Технические свойства : "Выбраны"
    И я заполняю форму открывшегося документа  
        ...
        И в таблице "Параметры СИ" из выпадающего списка с именем "Вид дифференцированности" я выбираю по строке 'Двухтарифный'
        Тогда в таблице "ПоказанияПриборовУчетаНетШкалЕстьТарифныеЗоны" количество строк "равно" 2
        И я нажимаю на кнопку 'Завершить'
