...
И я подготавливаю тестовые данные
    И я загружаю макет "ИзменениеВидаБлагоустройстваМКД.json"
...
И я создаю новый документ    
    ...
    И из выпадающего списка "МКД" я выбираю точное значение '652420, Кемеровская область - Кузбасс, Березовский г., Ленина пр-кт, дом № 8'
    Тогда открылось окно 'Изменить вид благоустройства МКД (создание) *'
    И в таблице "ВидыБлагоустройстваТарифныеКатегории" я перехожу к строке:
    | Вид благоустройства общедомовой                      | Услуга      |
    | 'отопление, дома строительным объемом от 10000 м3 +' | 'Отопление' |
