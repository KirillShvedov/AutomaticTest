#language: ru
    ...
    Сценарий: <РасчетПоСреднему>
        ...
        И я проверяю начисления за январь
            ...
            |'31.01.2020 23:59:59' |'Левашенко Зинаида Владимировна' |'Горячее водоснабжение' |'ввод_Горячее водоснабжение' |'Среднее по нормативу' |'357456'     |'81,980'        |'Нет'           |'276,27'                          |'01.01.2020'   |'01.02.2020'  |
            И в таблице "Список" текущая строка равна:
            |Сумма       |Объем услуги |Объем потребленный |
            |'828,82'    |'6,740000'   |'6,740000'         |
        И я проверяю начисления за февраль
            ...
            И в таблице "Список" я перехожу к строке:
            |Период                |Абонент                          |Услуга                  |Точка учета                  |Способ начисления      |Прибор учета |Значение тарифа |Сверх норматива |Сумма по повышенному коэффициенту |Начало периода |Конец периода |
            |'29.02.2020 23:59:59' |'Левашенко Зинаида Владимировна' |'Горячее водоснабжение' |'ввод_Горячее водоснабжение' |'Среднее по нормативу' |'357456'     |'81,980'        |'Нет'           |'276,27'                          |'01.02.2020'   |'01.03.2020'  |
            И в таблице "Список" текущая строка равна:
            |Сумма       |Объем услуги |Объем потребленный |
            |'828,82'    |'6,740000'   |'6,740000'         |
