...
Сценарий: <СнятиеСреднегоОбъемаСПределахСоц>
    ...
    И я проверяю полученные результаты
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                           |Услуга                   |Точка учета                          |Вид начисления |Способ начисления   |Направление использования ТУ |Прибор учета |Сверх норматива |Объем услуги соц норма |Конец периода |Начало периода |
        |'30.11.2019 23:59:59' |'Петровская Марина Александровна' |'Водоотведение'          |'ввод_ХВС + водоотведение_расчетная' |'Начисление'   |'По среднему'       |'Основное направление'       |'3164397а15' |'Нет'           |'8,380000'             |'01.12.2019'  |'01.11.2019'   |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный          |
        |'8,380000'   |'13,833333'                 |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                           |Услуга                   |Точка учета                          |Вид начисления |Способ начисления   |Направление использования ТУ |Прибор учета |Сверх норматива |Объем услуги соц норма |Конец периода |Начало периода |
        |'30.11.2019 23:59:59' |'Петровская Марина Александровна' |'Водоотведение'          |'ввод_ХВС + водоотведение_расчетная' |'Начисление'   |'По среднему'       |'Основное направление'       |'3164397а15' |'Да'            |''                     |'01.12.2019'  |'01.11.2019'   |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный          |
        |'5,453333'   |''                          |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                           |Услуга                   |Точка учета                          |Вид начисления |Способ начисления   |Направление использования ТУ |Прибор учета |Сверх норматива |Объем услуги соц норма |Конец периода |Начало периода |
        |'30.11.2019 23:59:59' |'Петровская Марина Александровна' |'Холодное водоснабжение' |'ввод_ХВС + водоотведение_расчетная' |'Начисление'   |'По среднему'       |'Основное направление'       |'3164397а15' |'Нет'           |'8,380000'             |'01.12.2019'  |'01.11.2019'   |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный          |
        |'8,380000'   |'13,833333'                 |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                           |Услуга                   |Точка учета                          |Вид начисления |Способ начисления   |Направление использования ТУ |Прибор учета |Сверх норматива |Объем услуги соц норма |Конец периода |Начало периода |
        |'30.11.2019 23:59:59' |'Петровская Марина Александровна' |'Холодное водоснабжение' |'ввод_ХВС + водоотведение_расчетная' |'Начисление'   |'По среднему'       |'Основное направление'       |'3164397а15' |'Да'            |''                     |'01.12.2019'  |'01.11.2019'   |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный          |
        |'5,453333'   |''                          |
        И в таблице "Список" я перехожу к строке:
