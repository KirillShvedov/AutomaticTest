...
Сценарий: <РасчетОтопленияПоСоцНорме>
    ...
    И Я проверяю полученные результаты
        ...
        |'0,824175'   |'1,703295'         |'825,69' |'0,824175'             |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                    |Услуга      |Точка учета      |Вид начисления |Способ начисления |Значение тарифа |Сверх норматива |
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                    |Услуга      |Точка учета      |Вид начисления |Способ начисления |Значение тарифа  |Сверх норматива  |
        |'31.09.2019 23:59:59' |'Еремина Нина Анатольевна' |'Отопление' |'узел_Отопление' |'Начисление'   |'По нормативу'    |'1 001,840'      |'Нет'            |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |Сумма    |Объем услуги соц норма |
        |'0,824175'   |'1,703295'         |'825,69' |'0,824175'             |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                    |Услуга      |Точка учета      |Вид начисления |Способ начисления |Значение тарифа |Сверх норматива |
        |'31.09.2019 23:59:59' |'Еремина Нина Анатольевна' |'Отопление' |'узел_Отопление' |'Начисление'   |'По нормативу'    |'1 300,000'     |'Да'            |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |Сумма      |Объем услуги соц норма |
        |'0,879120'   |''                 |'1 142,85' |''                     |
        #Октябрь
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                    |Услуга      |Точка учета      |Вид начисления |Способ начисления |Значение тарифа  |Сверх норматива  |
        |'31.11.2019 23:59:59' |'Еремина Нина Анатольевна' |'Отопление' |'узел_Отопление' |'Начисление'   |'По нормативу'    |'1 001,840'      |'Нет'            |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |Сумма    |Объем услуги соц норма |
        |'0,824175'   |'1,703295'         |'825,69' |'0,824175'             |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                    |Услуга      |Точка учета      |Вид начисления |Способ начисления |Значение тарифа |Сверх норматива |
        |'31.11.2019 23:59:59' |'Еремина Нина Анатольевна' |'Отопление' |'узел_Отопление' |'Начисление'   |'По нормативу'    |'1 300,000'     |'Да'            |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |Сумма      |Объем услуги соц норма |
        |'0,879120'   |''                 |'1 142,85' |''                     |
        #Декабрь
