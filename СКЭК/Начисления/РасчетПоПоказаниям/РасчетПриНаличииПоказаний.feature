    ...
    И я проверяю полученные результаты
        ...
        |'31.07.2019 23:59:59' |'Зимнухов Александр Викторович' |'Холодное водоснабжение' |'ввод_Холодное водоснабжение' |'По приборам'     |'Расчетная'                  |'0000000000000000000000005' |'Нет'           |'2,360000'             |
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                         |Услуга                   |Точка учета                   |Способ начисления |Направление использования ТУ |Прибор учета                |Сверх норматива |Объем услуги соц норма |
        |'31.07.2019 23:59:59' |'Зимнухов Александр Викторович' |'Холодное водоснабжение' |'ввод_Холодное водоснабжение' |'По приборам'     |'Расчетная'                  |'0000000000000000000000005' |'Да'            |''                     |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'30,640000'  |''                 |
