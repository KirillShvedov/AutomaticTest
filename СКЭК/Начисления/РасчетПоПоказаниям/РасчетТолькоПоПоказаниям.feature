    ...
    И я проверяю полученные результаты
        ...
        |'31.01.2020 23:59:59' |'Череповская Наталья Олеговна' |'Отопление' |'Начисление ОДН' |'Основное направление'       |'Да'            |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'0,652136'   |'0,652136'         |
        И в таблице "Список" я перехожу к строке:
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                        |Услуга      |Вид начисления   |Направление использования ТУ |Сверх норматива |
        |'29.02.2020 23:59:59' |'Череповская Наталья Олеговна' |'Отопление' |'Начисление ОДН' |'Основное направление'       |'Да'            |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'0,652136'   |''         |
