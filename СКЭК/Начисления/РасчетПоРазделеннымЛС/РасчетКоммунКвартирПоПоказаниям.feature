    ...
    И я проверяю полученные результаты    
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                   |Услуга                   |Точка учета                |Способ начисления |Сумма    |Сумма по повышенному коэффициенту |
        |'29.02.2020 23:59:59' |'Блинкова Ирина Петровна' |'Холодное водоснабжение' |'ввод      ХВС'            |'По приборам'     |'136,88' |''                                |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'4,000000'   |'4,000000'         |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                   |Услуга                   |Точка учета                |Способ начисления |Сумма    |Сумма по повышенному коэффициенту |
        |'29.02.2020 23:59:59' |'Блинов Павел Петрович'   |'Холодное водоснабжение' |'ввод'                     |'По приборам'     |'136,88' |''                                |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'4,000000'   |'4,000000'         |
        И в таблице "Список" я перехожу к строке:
