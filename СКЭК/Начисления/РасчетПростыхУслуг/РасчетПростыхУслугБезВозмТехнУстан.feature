    ...
    И я проверяю полученные результаты
        ...
        |'31.07.2019 23:59:59' |'Бирюков Дмитрий Юрьевич' |'Холодное водоснабжение' |'ввод_ХВС + водоотведение' |'По нормативу'    |'20,120'        |'Нет'           |'674,42' |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'33,520000'  |'33,520000'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                   |Услуга                   |Точка учета                |Способ начисления |Значение тарифа |Сверх норматива |Сумма      |
        |'31.07.2019 23:59:59' |'Бирюков Дмитрий Юрьевич' |'Водоотведение'          |'ввод_ХВС + водоотведение' |'По нормативу'    |'20,000'        |'Нет'           |'670,40'   |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'33,520000'  |'33,520000'        |
        #Август
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                   |Услуга                   |Точка учета                |Способ начисления |Значение тарифа |Сверх норматива |Сумма      |
        |'31.08.2019 23:59:59' |'Бирюков Дмитрий Юрьевич' |'Холодное водоснабжение' |'ввод_ХВС + водоотведение' |'По нормативу'    |'25,020'        |'Нет'           |'838,67'   |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'33,520000'  |'33,520000'        |
        И в таблице "Список" я перехожу к строке:
