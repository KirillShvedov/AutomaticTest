...
И Я открываю навигационную ссылку "e1cib/list/РегистрНакопления.энргОбъемНачислений"
			...
			| Период       			| Организация   | Филиал                      | Строение                             |Помещение  | Абонент                  | Услуга                 | Точка учета                    |
			| 31.07.2019 23:59:59 	| 'ОАО "СКЭК"'  | Кемеровский городской округ | Кемерово г, Цветочная 1-я ул, Дом № 1| 1         |Зуева надежда Игнатьевна 	| Холодное водоснабжение |расчетное_Холодное водоснабжение|
			И в таблице "Список" текущая строка равна:
			| Способ начисления   | Объем услуги | Объем потребленынй |
			| 'По приборам'       | 18           | 18                 |
            # Август 2019
            И в таблице "Список" я перехожу к строке:
			| Период       			| Организация   | Филиал                      | Строение                             |Помещение  | Абонент                  | Услуга                 | Точка учета                    |
			| 31.08.2019 23:59:59 	| 'ОАО "СКЭК"'  | Кемеровский городской округ | Кемерово г, Цветочная 1-я ул, Дом № 1| 1         |Зуева надежда Игнатьевна 	| Холодное водоснабжение |расчетное_Холодное водоснабжение|
			И в таблице "Список" текущая строка равна:
			| Способ начисления   | Объем услуги | Объем потребленынй |
			| 'По приборам'       | 26           | 26                 |
            # Сентябрь 2019
            И в таблице "Список" я перехожу к строке:
			| Период       			| Организация   | Филиал                      | Строение                             |Помещение  | Абонент                  | Услуга                 | Точка учета                    |
			| 31.09.2019 23:59:59 	| 'ОАО "СКЭК"'  | Кемеровский городской округ | Кемерово г, Цветочная 1-я ул, Дом № 1| 1         |Зуева надежда Игнатьевна 	| Холодное водоснабжение |расчетное_Холодное водоснабжение|
			И в таблице "Список" текущая строка равна:
			| Способ начисления   | Объем услуги | Объем потребленынй |
			| 'По приборам'       | 4            | 4                  |
            # Октябрь 2019
            И в таблице "Список" я перехожу к строке:
			| Период       			| Организация   | Филиал                      | Строение                             |Помещение  | Абонент                  | Услуга                 | Точка учета                    |
			| 31.10.2019 23:59:59 	| 'ОАО "СКЭК"'  | Кемеровский городской округ | Кемерово г, Цветочная 1-я ул, Дом № 1| 1         |Зуева надежда Игнатьевна 	| Холодное водоснабжение |расчетное_Холодное водоснабжение|
			И в таблице "Список" текущая строка равна:
			| Способ начисления         | Объем услуги | Объем потребленынй |
			| 'Начисление по среднему'  | 16           | 16                 | 
            # Ноябрь 2019
            И в таблице "Список" я перехожу к строке:
			| Период       			| Организация   | Филиал                      | Строение                             |Помещение  | Абонент                  | Услуга                 | Точка учета                    |
			| 31.11.2019 23:59:59 	| 'ОАО "СКЭК"'  | Кемеровский городской округ | Кемерово г, Цветочная 1-я ул, Дом № 1| 1         |Зуева надежда Игнатьевна 	| Холодное водоснабжение |расчетное_Холодное водоснабжение|
			И в таблице "Список" текущая строка равна:
			| Способ начисления         | Объем услуги | Объем потребленынй |
			| 'Начисление по среднему'  | 16           | 16                 |  
            # Декабрь 2019
            И в таблице "Список" я перехожу к строке:
			| Период       			| Организация   | Филиал                      | Строение                             |Помещение  | Абонент                  | Услуга                 | Точка учета                    |
			| 31.12.2019 23:59:59 	| 'ОАО "СКЭК"'  | Кемеровский городской округ | Кемерово г, Цветочная 1-я ул, Дом № 1| 1         |Зуева надежда Игнатьевна 	| Холодное водоснабжение |расчетное_Холодное водоснабжение|
			И в таблице "Список" текущая строка равна:
			| Способ начисления         | Объем услуги | Объем потребленынй |
			| 'Начисление по среднему'  | 16           | 16                 |  
            # Январь 2020
            И в таблице "Список" я перехожу к строке:
			| Период       			| Организация   | Филиал                      | Строение                             |Помещение  | Абонент                  | Услуга                 | Точка учета                    |
			| 31.01.2020 23:59:59 	| 'ОАО "СКЭК"'  | Кемеровский городской округ | Кемерово г, Цветочная 1-я ул, Дом № 1| 1         |Зуева надежда Игнатьевна 	| Холодное водоснабжение |расчетное_Холодное водоснабжение|
			И в таблице "Список" текущая строка равна:
