...
Сценарий: <расчет подчиненных услуг при наличии простых услуг>
    И я подготавливаю тестовые данные
        И я загружаю макет "СКЭК\Начисления\РасчетПодчиненныхУслуг\РасчетПодчиненныхУслугПриНаличииПростыхУслугИсходныеДанные.mxl"
