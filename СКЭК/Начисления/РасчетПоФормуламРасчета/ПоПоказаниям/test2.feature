    ...
    И я проверяю полученные результаты
        ...
        |Период                |Абонент                 |Услуга          |Точка учета       |Способ начисления     |
        |'31.07.2019 23:59:59' |'Овчаренко  Валентина ' |'Водоотведение' |'*_Водоотведение' |'По формулам расчета' |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'65,000000'  |'65,000000'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                 |Услуга          |Точка учета       |Способ начисления     |
        |'31.08.2019 23:59:59' |'Овчаренко  Валентина ' |'Водоотведение' |'*_Водоотведение' |'По формулам расчета' |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'17,000000'  |'17,000000'        |
        И в таблице "Список" я перехожу к строке:
        ...
        |''           |''                 |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                 |Услуга          |Точка учета       |Способ начисления     |Сумма    |
        |'30.09.2019 23:59:59' |'Овчаренко  Валентина ' |'Водоотведение' |'*_Водоотведение' |'По формулам расчета' |'304,02'|
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'18,000000'  |'18,000000'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                 |Услуга          |Точка учета       |Способ начисления     |
        |'31.10.2019 23:59:59' |'Овчаренко  Валентина ' |'Водоотведение' |'*_Водоотведение' |'По формулам расчета' |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'22,000000'  |'22,000000'        |
