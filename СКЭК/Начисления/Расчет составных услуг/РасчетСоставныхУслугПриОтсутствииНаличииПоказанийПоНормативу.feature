...
Сценарий: <РасчетСоставныхУслугПриОтсутствииНаличииПоказанийПоНормативу>
    ...
    И я проверяю полученные результаты
        ...
        #Сентябрь
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Вид начисления |Способ начисления      |Период начисления |
        |'30.09.2019 23:59:59' |'Холодное водоснабжение' |'Начисление'   |'Среднее по нормативу' |'01.09.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'10,020000'  |'10,020000'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Вид начисления |Способ начисления      |Период начисления |
        |'30.09.2019 23:59:59' |'Водоотведение'          |'Начисление'   |'Среднее по нормативу' |'01.09.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'7,180000'   |'7,180000'         |
        #Октябрь
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Вид начисления |Способ начисления      |Период начисления |
        |'31.10.2019 23:59:59' |'Холодное водоснабжение' |'Начисление'   |'Среднее по нормативу' |'01.10.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'10,020000'  |'10,020000'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Вид начисления |Способ начисления      |Период начисления |
        |'31.10.2019 23:59:59' |'Водоотведение'          |'Начисление'   |'Среднее по нормативу' |'01.10.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'7,180000'   |'7,180000'         |
        #Ноябрь
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Вид начисления |Способ начисления      |Период начисления |
        |'30.11.2019 23:59:59' |'Холодное водоснабжение' |'Перерасчет'   |'Среднее по нормативу' |'01.09.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'-10,020000' |'-10,020000'       |
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Вид начисления |Способ начисления      |Период начисления |
        |'30.11.2019 23:59:59' |'Водоотведение'          |'Перерасчет'   |'Среднее по нормативу' |'01.09.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'-7,180000'  |'-7,180000'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Вид начисления |Способ начисления      |Период начисления |
        |'30.11.2019 23:59:59' |'Холодное водоснабжение' |'Перерасчет'   |'Среднее по нормативу' |'01.10.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'-10,020000' |'-10,020000'       |
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Вид начисления |Способ начисления      |Период начисления |
        |'30.11.2019 23:59:59' |'Водоотведение'          |'Перерасчет'   |'Среднее по нормативу' |'01.10.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'-7,180000'  |'-7,180000'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Точка учета                            |Вид начисления |Способ начисления      |Прибор учета |Период начисления |
        |'30.11.2019 23:59:59' |'Водоотведение'          |'ввод_ХВС + водоотведение'             |'Перерасчет'   |'Среднее по нормативу' |'000663914'  |'01.09.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'4,000000'   |'4,000000'         |
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Точка учета                            |Вид начисления |Способ начисления      |Прибор учета |Период начисления |
        |'30.11.2019 23:59:59' |'Холодное водоснабжение' |'ввод_ХВС + водоотведение'             |'Перерасчет'   |'Среднее по нормативу' |'000663914'  |'01.09.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'4,000000'   |'4,000000'         |
        И в таблице "Список" я перехожу к строке:
        |Период                |Услуга                   |Точка учета                            |Вид начисления |Способ начисления      |Прибор учета |Период начисления |
        |'30.11.2019 23:59:59' |'Водоотведение'          |'стоки_ГВС + водоотведение'            |'Перерасчет'   |'Среднее по нормативу' |'000653714'  |'01.09.2019'      |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'4,000000'   |'4,000000'         |
        #Декабрь
