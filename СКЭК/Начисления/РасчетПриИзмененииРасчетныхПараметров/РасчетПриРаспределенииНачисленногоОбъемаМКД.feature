    ...
    И я перепровожу загруженные документы
        ...
        И в таблице 'Список' я выделяю все строки
        И я выбираю пункт контекстного меню с именем 'СписокКонтекстноеМенюПровести' на элементе формы с именем "Список"  
    И Я запускаю выполнение начислений по организации 'ОАО "СКЭК"' и району 'Березовский городской округ' и МКД '' с 'Июль' '2019' по 'Июль 2019'
    И я проверяю полученные результаты
        ...
        |Период                |Абонент                  |Распределение |Услуга      |Точка учета          |Вид начисления   |Способ начисления |Направление использования ТУ |Сверх норматива |
        |'31.07.2019 23:59:59' |'Шевелев Виктор Павлович'|'нет'         |'Отопление' |'квартира_Отопление' |'Начисление'     |'По нормативу'    |'Основное направление'       |'Нет'           |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'1,014892'   |'1,014892'         |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                  |Распределение  |Услуга      |Точка учета          |Вид начисления   |Способ начисления |Направление использования ТУ |Сверх норматива |
        |'31.07.2019 23:59:59' |'Шевелев Виктор Павлович'|'да'           |'Отопление' |'квартира_Отопление' |'Начисление'     |'По нормативу'    |'Основное направление'       |'Нет'           |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'-1,014892'  |'-1,014892'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                  |Распределение |Услуга      |Точка учета          |Вид начисления   |Способ начисления |Направление использования ТУ |Сверх норматива |
        |'31.07.2019 23:59:59' |'Шевелев Виктор Павлович'|'да'          |'Отопление' |'квартира_Отопление' |'Начисление'     |'По приборам'     |'Основное направление'       |'Нет'           |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'1,097591'   |''         |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                  |Распределение |Услуга      |Точка учета          |Вид начисления   |Способ начисления |Направление использования ТУ |Сверх норматива |
        |'31.07.2019 23:59:59' |'Шевелев Виктор Павлович'|'да'          |'Отопление' |''                   |'Начисление ОДН' |'По приборам'     |'Основное направление'       |'Да'            |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'0,115950'   |''                 |      