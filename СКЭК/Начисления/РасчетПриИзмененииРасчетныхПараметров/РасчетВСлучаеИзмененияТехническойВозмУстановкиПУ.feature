...
Сценарий: <расчет в случае изменения технической возможности установки ПУ>
    ...
    И я перепровожу загруженные данные
       ...
       И в таблице "Список" я перехожу к строке:
        ...
        |'31.07.2019 23:59:59' |'Туманова Светлана Владимировна' |'Холодное водоснабжение' |'подвал_Холодное водоснабжение' |'Начисление'   |'Среднее по нормативу' |
        И в таблице "Список" текущая строка равна:
        |Сумма    |Объем услуги |Объем потребленный |
        |'200,55'  |'4,160000'   |'4,160000'        |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                          |Услуга                   |Точка учета                     |Вид начисления |Способ начисления      |
        |'31.08.2019 23:59:59' |'Туманова Светлана Владимировна' |'Холодное водоснабжение' |'подвал_Холодное водоснабжение' |'Начисление'   |'Среднее по нормативу' |
        И в таблице "Список" текущая строка равна:
        |Сумма    |Объем услуги |Объем потребленный |
