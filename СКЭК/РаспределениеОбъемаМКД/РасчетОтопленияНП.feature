    ...
    И я проверяю начисления по нежилому помещению
        ...
        |Период                |Договор                                  |Объект расчета |Услуга      |Точка учета                   |Вид начисления   |Способ начисления |Распределение |Поставщик       |
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Договор                                  |Объект расчета |Услуга      |Точка учета                   |Вид начисления   |Способ начисления |Распределение |Поставщик       |
        |'31.01.2020 23:59:59' |'Договор № 119 тэ от 01.01.2020 0:00:00' |'Строитель'    |'Отопление' |''                            |'Начисление ОДН' |''                |'Да'          |'Тарасова С.П.' |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'0,434448'   |''                 |
        И в таблице "Список" я перехожу к строке:
