    ...
    И я проверяю начисления по нежилому помещению
        ...
        |Период                |Договор                                  |Объект расчета |Услуга      |Точка учета                   |Вид начисления   |Способ начисления |Распределение |
        |'31.01.2020 23:59:59' |'Договор № 119 тэ от 01.01.2020 0:00:00' |'Строитель'    |'Отопление' |'служебная комната_Отопление' |'Начисление'     |'По нормативу'    |'Нет'         |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'5,855736'   |'5,855736'         |
        И в таблице "Список" я перехожу к строке:
        |Период                |Договор                                  |Объект расчета |Услуга      |Точка учета                   |Вид начисления   |Способ начисления |Распределение |
        |'31.01.2020 23:59:59' |'Договор № 119 тэ от 01.01.2020 0:00:00' |'Строитель'    |'Отопление' |''                            |'Начисление ОДН' |''                |'Да'          |
        И в таблице "Список" текущая строка равна:
        |Объем услуги |Объем потребленный |
        |'0,455446'   |''                 |
        И в таблице "Список" я перехожу к строке:
