...
Сценарий: <перерасчет в случае корректировки показаний по отоплению>
    И я подготавливаю тестовые данные
        И я загружаю макет "СКЭК\Перерасчет\КорректировкаПоказаний\ПерерасчетВСлучаеКорректировкиПоказанийПоОтоплениюИсходныеДанные.mxl"
        И я перепровожу созданные документы
            ...
            И в таблице 'Список' я выделяю все строки
            И я выбираю пункт контекстного меню с именем 'СписокКонтекстноеМенюПровести' на элементе формы с именем "Список"
    И Я запускаю выполнение начислений по организации 'ОАО "СКЭК"' и району 'Березовский городской округ' с 'Июль' '2019' по 'Ноябрь 2019'
