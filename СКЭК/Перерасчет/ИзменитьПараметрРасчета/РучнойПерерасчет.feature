    ...
    И я заполняю перерасчет
        ...
        И в таблице "ДвиженияэнргОбъемНачислений" из выпадающего списка с именем "ДвиженияэнргОбъемНачисленийТочкаУчета" я выбираю точное значение 'ввод_ХВС + водоотведение'
        ...
        И в таблице "ДвиженияэнргОбъемНачислений" я перехожу к строке:
        |N   |Расчетный период |Поставщик         |Точка учета                 |Услуга                      |Прибор учета |Способ начисления     |Направление использования ТУ |Шкала |Измеритель |Объем услуги |Объем потребленный |Сумма    |Значение тарифа |
        |'9' |'Январь 2019'    |'Тайгинское ВКХ'  |'ввод_ХВС + водоотведение'  |'Холодное водоснабжение'    |''           |''                    |'Основное направление'       |''    |''         |''           |''                 |''       |''              |
        ...
        И в таблице "ДвиженияэнргОбъемНачислений" я перехожу к строке:
        |N   |Расчетный период |Поставщик        |Точка учета                 |Услуга                   |Прибор учета |Способ начисления     |Направление использования ТУ |Шкала |Измеритель |Объем услуги |Объем потребленный |Сумма    |Значение тарифа |
        |'9' |'Январь 2019'    |'Тайгинское ВКХ' |'ввод_ХВС + водоотведение'  |'Холодное водоснабжение' |''           |'Актированный расход' |'Основное направление'       |''    |''         |'12,000000'  |''                 |''       |'20,120'        |
