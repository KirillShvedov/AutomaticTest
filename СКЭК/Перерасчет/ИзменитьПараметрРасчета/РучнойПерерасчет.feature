    ...
    И я заполняю перерасчет
        ...
        И в таблице "ДвиженияэнргОбъемНачислений" из выпадающего списка с именем "ДвиженияэнргОбъемНачисленийТочкаУчета" я выбираю точное значение 'авто                                              '
        ...
        И в таблице "ДвиженияэнргОбъемНачислений" из выпадающего списка с именем "ДвиженияэнргОбъемНачисленийСпособНачисления" я выбираю по строке 'Актирова'
        ...
        И в таблице "ДвиженияэнргОбъемНачислений" я перехожу к строке:
        |N   |Расчетный период |Поставщик        |Точка учета                |Услуга                   |Прибор учета |Способ начисления     |Направление использования ТУ |Шкала |Измеритель |Объем услуги |Объем потребленный |Сумма    |Значение тарифа |
        |'9' |'Январь 2019'    |'Тайгинское ВКХ' |'авто'                     |'Холодное водоснабжение' |''           |'Актированный расход' |'мытье автомобиля'           |''    |''         |'12,000000'  |''                 |''       |''              |
