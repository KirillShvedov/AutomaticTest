#language: ru
    ...
    И я проверяю полученный результат
        ...
        |Период                |Регистратор                                     |Организация            |Филиал                       |Абонент                   |Период начисления |
        |'17.04.2020 12:00:02' |'Перерасчет 00000000054 от 17.04.2020 12:00:02' |'ООО "Тайгинское ВКХ"' |'Тайгинский городской округ' |'Бирюков Дмитрий Юрьевич' |'01.04.2020'      |
        ...
        И в таблице "Список" я перехожу к строке:
        |Период                |Регистратор                                     |Организация            |Филиал                       |Абонент                   |Период начисления |
        |'30.04.2020 23:59:59' |'Начисление 00000000017 от 30.04.2020 23:59:58' |'ООО "Тайгинское ВКХ"' |'Тайгинский городской округ' |'Бирюков Дмитрий Юрьевич' |'01.04.2020'      |
        И в таблице "Список" текущая строка равна:
        |Сумма      |
        |'674,42'   |
        И в таблице "Список" я перехожу к строке:
