            ...
            И я проверяю правильность расчета услуги ХВС                 
                    ...
                    | '01.07.2019'      | 'Холодное водоснабжение'  | 'ввод_ХВС + водоотведение'    |'01.07.2019'    |'01.08.2019'   | 
                    ...
                    И в таблице "Расшифровка" я перехожу к строке:
                    | Период начисления | Услуга                    | Точка учета                   | Начало периода | Конец периода |
                    | '01.08.2019'      | 'Холодное водоснабжение'  | 'ввод_ХВС + водоотведение'    |'01.08.2019'    |'01.09.2019'   | 
                    И в таблице "Расшифровка" текущая строка равна:
                    | Способ начисления | Объем услуги | Объем потребленный |
                    | 'По приборам'     | '0,000000'   | '0,000000'         |
                    И в таблице "Расшифровка" я перехожу к строке:
                    | Период начисления | Услуга                    | Точка учета                   | Начало периода | Конец периода |
                    | '01.09.2019'      | 'Холодное водоснабжение'  | 'ввод_ХВС + водоотведение'    |'01.09.2019'    |'01.10.2019'   | 
                    И в таблице "Расшифровка" текущая строка равна:
                    | Способ начисления | Объем услуги | Объем потребленный |
                    | 'По приборам'     | '0,000000'   | '0,000000'         |
            И я проверяю правильность расчета услуги водоотведение               
                    И в таблице "Расшифровка" я перехожу к строке:
                    | Период начисления | Услуга                    | Точка учета                   | Начало периода | Конец периода |
                    | '01.07.2019'      | 'Водоотведение'           | 'ввод_ХВС + водоотведение'    |'01.07.2019'    |'01.08.2019'   | 
                    И в таблице "Расшифровка" текущая строка равна:
                    | Способ начисления | Объем услуги | Объем потребленный |
                    | 'По приборам'     | '4,000000'   | '4,000000'         |
                    И в таблице "Расшифровка" я перехожу к строке:
                    | Период начисления | Услуга                    | Точка учета                   | Начало периода | Конец периода |
                    | '01.08.2019'      | 'Водоотведение'           | 'ввод_ХВС + водоотведение'    |'01.08.2019'    |'01.09.2019'   | 
                    И в таблице "Расшифровка" текущая строка равна:
                    | Способ начисления | Объем услуги | Объем потребленный |
                    | 'По приборам'     | '0,000000'   | '0,000000'         |
                    И в таблице "Расшифровка" я перехожу к строке:
                    | Период начисления | Услуга                    | Точка учета                   | Начало периода | Конец периода |
                    | '01.09.2019'      | 'Водоотведение'           | 'ввод_ХВС + водоотведение'    |'01.09.2019'    |'01.10.2019'   | 
                    И в таблице "Расшифровка" текущая строка равна:
                    | Способ начисления | Объем услуги | Объем потребленный |
                    | 'По приборам'     | '0,000000'   | '0,000000'         |   
                 И я перехожу к закладке "Результат"
            И я проверяю правильность расчета услуги водоотведение               
                    И в таблице "Результат" я перехожу к строке:
                    | Период начисления | Услуга      |          
                    | '01.07.2019'      | 'Отопление' |
                    И в таблице "Результат" текущая строка равна:
                    | Направление использования ТУ | РезультатПерерасчетаОбъемУслугиДо | РезультатПерерасчетаОбъемУслугиПосле | РезультатПерерасчетаСуммаДо| РезультатПерерасчетаСуммаПосле |
                    | 'Основное направление'       | '2,200298'                        | '2,200298'                           |  '3 805,77'                |   '3 805,77'                   |
                     И в таблице "Результат" я перехожу к строке:
                    | Период начисления | Услуга      |          
                    ...
                    И в таблице "Результат" текущая строка равна:
                    | Направление использования ТУ | РезультатПерерасчетаОбъемУслугиДо | РезультатПерерасчетаОбъемУслугиПосле | РезультатПерерасчетаСуммаДо| РезультатПерерасчетаСуммаПосле |
                    | 'Основное направление'       | '2,200298'                        | '2,200298'                           |  '3 805,76'                |   '3 805,76'                   |
