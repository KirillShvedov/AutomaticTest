...
Сценарий: <описание сценария>
    ...
    И я проверяю полученные результаты
        ...
        И я проверяю правильность расчета услуги хвс полив
            ...
            | Период начисления | Услуга                    | Точка учета                    | Направление использования ТУ     | Начало периода | Конец периода |
            | '01.08.2019'      | 'Холодное водоснабжение'  | 'полив_Холодное водоснабжение' | 'полив из водопровода'           | '01.08.2019'   | '01.09.2019'  | 
            И в таблице "Расшифровка" текущая строка равна:
            | Объем услуги | Объем потребленный     |
            | '22,931010'  | '22,931010'            |
            И в таблице "Расшифровка" я перехожу к строке:
            | Период начисления | Услуга                    | Точка учета                    | Направление использования ТУ | Начало периода | Конец периода |
            | '01.09.2019'      | 'Холодное водоснабжение'  | 'полив_Холодное водоснабжение' | 'полив из водопровода'         | '01.09.2019'   | '30.09.2019'  | 
            И в таблице "Расшифровка" текущая строка равна:
        ...
        И я проверяю правильность расчета услуги хвс баня
            И в таблице "Расшифровка" я перехожу к строке:
            | Период начисления | Услуга                    | Точка учета                    | Направление использования ТУ | Начало периода | Конец периода |
            | '01.08.2019'      | 'Холодное водоснабжение'  | 'баня_Холодное водоснабжение' | 'мытье в бане'                 | '01.08.2019'   | '01.09.2019'  | 
            И в таблице "Расшифровка" текущая строка равна:
            | Способ начисления | Объем услуги | Объем потребленный |
            | 'По нормативу'     | '0,800000'   | '0,800000'      |
            И в таблице "Расшифровка" я перехожу к строке:
            | Период начисления | Услуга                    | Точка учета                    | Направление использования ТУ | Начало периода | Конец периода |
            | '01.09.2019'      | 'Холодное водоснабжение'  | 'баня_Холодное водоснабжение'  | 'мытье в бане'               | '01.09.2019'   | '01.10.2019'  | 
            И в таблице "Расшифровка" текущая строка равна:
            | Способ начисления | Объем услуги | Объем потребленный |
            | 'По нормативу'     | '0,800000'   | '0,800000'        |
