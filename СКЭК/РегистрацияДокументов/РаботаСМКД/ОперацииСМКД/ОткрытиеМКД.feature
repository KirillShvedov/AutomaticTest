...
Сценарий: <описание сценария>
    И я подготавливаю тестовые данные
        И я загружаю макет "СКЭК\РегистрацияДокументов\РаботаСМКД\ОперацииСМКД\ОткрытиеМКД.mxl"
    ...
    И я заполняю форму открывшегося документа
        ...
        И из выпадающего списка "Улица" я выбираю по строке 'ягодная'
        И из выпадающего списка "Дом" я выбираю по строке '13'
