...
Сценарий: <описание сценария>
    И я подготавливаю тестовые данные
        И я загружаю макет "СКЭК\РегистрацияДокументов\РаботаСМКД\ОперацииСМКД\ЗакрытиеМКД.mxl"
    ...
    И я заполняю форму открывшегося документа    
        ...
        |'1' |'служебная комната_Холодное водоснабжение' |'Холодное водоснабжение' |'м3'    |'УУ123123'     |'Одноканальный ХВ' |
