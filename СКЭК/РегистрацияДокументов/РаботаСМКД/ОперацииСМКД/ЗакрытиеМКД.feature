    ...
    И я восстанавливаю последовательность
        ...
        И из выпадающего списка "Территориальный орган" я выбираю по строке 'Бере'
        И я нажимаю на гиперссылку "Восстановление последовательности документов"
        И я выбираю пункт меню 'Выполнить операцию'
        И я перехожу к следующему реквизиту
        И я перехожу к следующему реквизиту
        И я перехожу к закладке "Физические лица"
        И я нажимаю на гиперссылку "Восстановление последовательности показаний ПУ"
        И я выбираю пункт меню 'Выполнить операцию'
