#language: ru
    ...
    И я заполняю форму открывшегося документа    
        ...
        Тогда в таблице "ШкалыПриборовУчетаЕстьШкалыНетТарифныхЗон" количество строк "равно" 1
        И в таблице "ТочкиУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Точка учета                   |Услуга                   |Ед.изм. |Прибор учета  |Вид канальности    |
        |'ввод_Холодное водоснабжение' |'Холодное водоснабжение' |'м3'    |'1011244350'  |'Одноканальный ХВ' |
