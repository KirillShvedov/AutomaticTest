    ...
    И я подготавливаю тестовые данные
        И я загружаю макет "СоглашениеОПотребленииМеждуРазделеннымиЛС"
    ...
    И я заполняю форму открывшегося документа   
        ...
        И из выпадающего списка с именем "Услуга" я выбираю по строке 'Отопление'
        И в таблице "Абоненты" я перехожу к строке:
        | Абонент                    | Помещение | Строение                                | Точка учета        | Услуга      |
        | 'Ложкин Владимир Иванович' | ' 2'      | 'Березовский г., Киевская ул, Дом № 30' | 'подвал_Отопление' | 'Отопление' |
        ...
        И в таблице "Абоненты" я перехожу к строке:
        | Абонент                         | Помещение    | Строение                                | Точка учета        | Услуга      |
        | 'Кузнецова Зинаида Григорьевна' | ' 1'         | 'Березовский г., Киевская ул, Дом № 30' | 'подвал_Отопление' | 'Отопление' |
