    ...
    И я проверяю полученные результаты
        ...
        |'31.07.2019 23:59:59' |'652420, Кемеровская область - Кузбасс, Березовский г., Ленина пр-кт, дом № 8' |'Отопление' |'ввод_Отопление' |'Начисление'   |'По приборам'            |'УУ846564рр               '|'01.07.2019'      |
