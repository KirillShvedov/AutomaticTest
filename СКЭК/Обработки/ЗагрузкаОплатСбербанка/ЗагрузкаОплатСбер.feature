    ...
    И я проверяю ТЧ "Показания приборов учета"
        ...
        |'Да'          |'Основная' |'221,0000'           |'30.09.2020'             |'225,0000'        |'Отклонены'         |'4,000000' |'66,53'         |'266,12' |
        И в таблице "ТочкиУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Строение                                      |Помещение |Абонент                         |Номер ЛС |Точка учета                    |Услуга                   |Прибор учета    |Вид канальности    |
        ...
        И в таблице "ШкалыПриборовУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Предоставлены |Шкала      |Предыдущие показания |Дата последних показаний |Текущие показания |Состояние показаний |Разница    |Значение тарифа |Сумма    |
        |'Да'          |'Основная' |'129,0000'           |'30.09.2020'             |'134,0000'        |'Приняты'           |'5,000000' |'60,59'         |'302,95' |
        И в таблице "ТочкиУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Строение                                      |Помещение |Абонент                         |Номер ЛС |Точка учета                    |Услуга                   |Прибор учета    |Вид канальности    |
        ...
        И в таблице "ШкалыПриборовУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Предоставлены |Шкала      |Предыдущие показания |Дата последних показаний |Текущие показания |Состояние показаний   |Разница      |Значение тарифа |Сумма    |
        |'Да'          |'Основная' |'2 208,0000'         |'30.09.2020'             |'2 198,0000'      |'Отклонены'           |'-10,000000' |'23,62'         |''       |
        И в таблице "ТочкиУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Строение                                      |Помещение |Абонент                         |Номер ЛС |Точка учета                    |Услуга                   |Прибор учета    |Вид канальности    |
        ...
        И в таблице "ШкалыПриборовУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Предоставлены |Шкала      |Предыдущие показания |Дата последних показаний |Текущие показания |Состояние показаний   |Разница      |Значение тарифа |Сумма    |
        |'Да'          |'Основная' |'3 720,0000'         |'30.09.2020'             |'3 710,0000'      |'Отклонены'           |'-10,000000' |'30,58'         |''       |
