    ...
    И я проверяю ТЧ "Оплата"    
        ...
        |Абонент                             |Лицевой счет          |Строение                                       |Помещение |Услуга                   |Поставщик    |Период оплаты |Примечание |Сумма оплаты |Дата платежа |Номер платежа                              |ФИО плательщика |
        |'Безруков Владимир Васильевич'      |'0300000523        '  |'Кемерово г, Рябиновая ул, Дом № 6'            |'1'       |'Холодное водоснабжение' |''           |'Август 2020' |''         |'272,90'     |'29.08.2020' |'2020082986158615999V09399166301265822206' |''              |
        И в таблице "Оплата" я перехожу к строке:
        |Абонент                             |Лицевой счет          |Строение                                       |Помещение |Услуга                   |Поставщик    |Период оплаты |Примечание |Сумма оплаты |Дата платежа |Номер платежа                              |ФИО плательщика |
        |'Марков Георгий Алексеевич'         |'0300002182        '  |'Кемерово г, Междуреченская ул, Дом № 21'      |''        |'Холодное водоснабжение' |''           |'Август 2020' |''         |'731,64'     |'30.08.2020' |'2020083086159900000V08436663800852842845' |''              |
        И в таблице "Оплата" я перехожу к строке:
        |Абонент                             |Лицевой счет          |Строение                                       |Помещение |Услуга                   |Поставщик    |Период оплаты |Примечание |Сумма оплаты |Дата платежа |Номер платежа                              |ФИО плательщика |
        |'Швыдкин Владимир Владимирович'     |'0300003710        '  |'Кемерово г, Стадионная ул, Дом № 22'          |'2'       |'Горячее водоснабжение'  |''           |'Июль 2020'   |''         |'1 500,00'   |'21.09.2020' |'2020092186158615999V00931315451429824980' |''              |
        И в таблице "Оплата" я перехожу к строке:
        |Абонент                             |Лицевой счет          |Строение                                       |Помещение |Услуга                   |Поставщик    |Период оплаты |Примечание |Сумма оплаты |Дата платежа |Номер платежа                              |ФИО плательщика |
        |'Швыдкин Владимир Владимирович'     |'0300003710        '  |'Кемерово г, Стадионная ул, Дом № 22'          |'2'       |'Холодное водоснабжение' |''           |'Июль 2020'   |''         |'70,00'      |'21.09.2020' |'2020092186158615999V00931315451429824980' |''              |
        И в таблице "Оплата" я перехожу к строке:
        |Абонент                             |Лицевой счет          |Строение                                       |Помещение |Услуга                   |Поставщик    |Период оплаты |Примечание |Сумма оплаты |Дата платежа |Номер платежа                              |ФИО плательщика |
        |'Пименов Сергей Владимирович'       |'0300000265        '  |'Кемерово г, Греческая деревня ул, Дом № 213'  |''        |'Холодное водоснабжение' |''           |'Август 2020' |''         |'140,00'     |'30.08.2020' |'2020083086158615999V00097890601054962405' |''              |
        И в таблице "Оплата" я перехожу к строке:
        |Абонент                             |Лицевой счет          |Строение                                       |Помещение |Услуга                   |Поставщик    |Период оплаты |Примечание |Сумма оплаты |Дата платежа |Номер платежа                              |ФИО плательщика |
        |'Штаревич Оксана Александровна'     |'0300003656        '  |'Кемерово г, Промышленновское ш, Дом № 33А'    |''        |'Холодное водоснабжение' |''           |'Август 2020' |''         |'1 000,00'   |'28.08.2020' |'2020082886158615999V08560946301264743407' |''              |
        И в таблице "Оплата" я перехожу к строке:
        |Абонент                             |Лицевой счет          |Строение                                       |Помещение |Услуга                   |Поставщик    |Период оплаты |Примечание |Сумма оплаты |Дата платежа |Номер платежа                              |ФИО плательщика |
        |'Соломенников Сергей Александрович' |'0300001025        '  |'Кемерово г, Первомайская ул, Дом № 23'        |''        |'Холодное водоснабжение' |''           |'Август 2020' |''         |'278,72'     |'28.08.2020' |'2020082886159900000V04979674800848380622' |''              |
    И я проверяю ТЧ "Показания приборов учета"
        ...
        |Номер ЛС               |Абонент                         |Строение                                       |Помещение |Точка учета                    |Услуга                   |Прибор учета    |
        |'0300002182        '   |'Марков Георгий Алексеевич'     |'Кемерово г, Междуреченская ул, Дом № 21'      |''        |'+ввод_Холодное водоснабжение' |'Холодное водоснабжение' |'07274980'      |
        ...
        И в таблице "ТочкиУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Номер ЛС               |Абонент                         |Строение                                       |Помещение |Точка учета                    |Услуга                   |Прибор учета    |
        |'0300003710        '   |'Швыдкин Владимир Владимирович' |'Кемерово г, Стадионная ул, Дом № 22'          |'2'       |'+ввод_ХВС + водоотведение'    |'ХВС + водоотведение'    |'12012'         |
        И в таблице "ШкалыПриборовУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        ...
        И в таблице "ТочкиУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Номер ЛС               |Абонент                         |Строение                                       |Помещение |Точка учета                    |Услуга                   |Прибор учета    |
        |'0300003710        '   |'Швыдкин Владимир Владимирович' |'Кемерово г, Стадионная ул, Дом № 22'          |'2'       |'ввод_ГВС + водоотведение'     |'ГВС + водоотведение'    |'1019063370400' |
        И в таблице "ШкалыПриборовУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Предоставлены |Предыдущие показания |Дата последних показаний |Текущие показания |Состояние показаний   |Разница           |Значение тарифа |Сумма       |
        |'Да'          | '129,0000'          | '31.08.2020'            | '134,0000'       | 'Приняты'            | '5,000000'       | '60,59'        | '302,95'   |
        И в таблице "ТочкиУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Номер ЛС               |Абонент                         |Строение                                       |Помещение |Точка учета                    |Услуга                   |Прибор учета    |
        |'0300000265        '   |'Пименов Сергей Владимирович'   |'Кемерово г, Греческая деревня ул, Дом № 213'  |''        |'+ввод_ХВС + водоотведение'    |'ХВС + водоотведение'    |'324098'        |
        И в таблице "ШкалыПриборовУчетаЕстьШкалыНетТарифныхЗон" я перехожу к строке:
        |Предоставлены |Предыдущие показания   |Дата последних показаний |Текущие показания   |Состояние показаний     |Разница            |Значение тарифа |Сумма       |
    ...
    И я проверяю ТЧ "Отклоненные данные"
        И я перехожу к закладке "Отклоненные данные"
